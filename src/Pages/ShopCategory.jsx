...
import ladiesBanner from '../assets/ladies/ladiesBanner2.jpeg'
  ...
  return (
    <div className='h-full p-4 flex flex-col flex-wrap'>
      <div className='flex items-center justify-center p-4'>
        <img src={ladiesBanner} alt="" className='w-[1000px] h-[200px] md:h-[400px] object-contain'/>
      </div>
      ...
      <div className='xl:grid grid-cols-4 flex flex-wrap bg-purple-500 items-center justify-around p-8 rounded-[10px]'>
